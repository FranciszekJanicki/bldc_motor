...
typedef struct {
    void* hall_user;
    bldc_motor_err_t (*hall_initialize)(void*);
    bldc_motor_err_t (*hall_deinitialize)(void*);
    bldc_motor_err_t (*hall_get_position)(void*, bldc_motor_position_t*);

    void* pwm_user;
    bldc_motor_err_t (*pwm_initialize)(void*, bldc_motor_channel_t);
    bldc_motor_err_t (*pwm_deinitialize)(void*, bldc_motor_channel_t);
